...
<html lang="es" class="html">
  <head>
    ...
    <link rel="icon" href="public/img/001.jpegicono.ico">
    <title>Ricwer</title>
  </head>
  <body>
      ...
      <ul class="nav justify-content-center">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="app/vista/calzado_hombre.php">Hombre</a></li>
            <li><a class="dropdown-item" href="app/vista/calzado_mujer.php">Mujer</a></li>
            <li><a class="dropdown-item" href="app/vista/calzado_niños.php">Niños</a></li>
          </ul>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="app/vista/empresa.php">Empresa</a>
        </li>
        
        <li class="nav-item">
        <a href="app/vista/carrito.php" >
        ...
        <?php
                                if($login==TRUE)
                                {
                                    ?>
                                    <li class="nav-item">
          <a class="nav-link" href="app/vista/menu.php">Sistema</a>
        </li>
        <li class="nav-item">
                        ...
                        <?php
                            switch($login)
                            {
                                ...
                                ?>
                                <li class="nav-item">
                                    <a class="nav-link" href="app/vista/login.php">Inicio Sesion</a>
                                </li>
                        <?php  
                                    break;
                                case TRUE:
       ...
       <div id="carousel" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active" data-bs-interval="3000">
            <img src="public/img/carrusel1.png" width="100%" alt="public/img/011.jpeg">
          </div>
         
 
          <div class="carousel-item" data-bs-interval="3000">
            <img src="public/img/carrusel2.png" width="100%" alt="public/img/012.jpeg">
          </div>
 
 
          <div class="carousel-item" data-bs-interval="3000">
            <img src="public/img/carrusel3.png" width="100%" alt="public/img/013.jpeg">
          </div>
    ...
    <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="2" aria-label="Slide 3"></button>
      ...
      <section class="d-flex flex-column justify-content-center align-items-center pt-5  text-center w-50 m-auto" id="intro">
        <p class="p-3  fs-4">
           <b>ENCUENTRE LOS MEJORE ZAPATOS PARA TODA LA FAMILIA CON LA MEJOR CALIDAD Y A UN BUEN PRECIO</b>     
        </p>   
       </section>
...
<section class="contenedor">
        ...
        <div class="contenedor-items">
            ...
            <a class="nav-link" href="app/vista/producto.php?id=<?php echo $row['idProducto']; ?>&token=<?php echo hash_hmac('sha1', $row['idProducto'], KEY_TOKEN);?>">
            <div class="item">
                <?php
                $id = $row['idProducto'];
                $imagen = "public/img/00".$id.".jpeg";
    ...
    <section class="d-flex flex-column justify-content-center align-items-center pt-5  text-center w-50 m-auto" id="intro">
        <p class="p-3  fs-4">
           <b>Productos mas populares.</b>     
        </p>   
       </section>
       <section class="contenedor">
       <div class="contenedor-items">
            <?php foreach($resultado as $row){?>
            <a class="nav-link" href="app/vista/producto.php">
            <div class="item">
                <?php
                $id = $row['idProducto'];
                $imagen = "public/img/10".$id.".jpeg";
                if(!file_exists($imagen)){
                    $imagen= "public/img/101.jpeg";
                }
                ?>
                <span class="titulo-item"><?php echo $row['nombreProducto']; ?></span>
                <img src="<?php echo $imagen; ?>" alt="" class="img-item">
...
<footer class="footer">
    <div class="container">
        ...
        <div class="footer-links">
                <h4>Compañia</h4>
                <ul>
                    <li><a href="app/vista/empresa.php">Nosotros</a></li>
                    <li><a href="app/vista/empresa.php">Nuestros Servicios</a></li>
                    <li><a href="app/vista/empresa.php">Politica de Privacidad</a></li>
                    <li><a href="app/vista/empresa.php">Informacion</a></li>
                </ul>
            </div>
            <div class="footer-links">
                <h4>Ayuda</h4>
                <ul>
                    <li><a href="app/vista/empresa.php">Sugerencias</a></li>
                    <li><a href="app/vista/empresa.php">Quejas</a></li>
                    <li><a href="app/vista/empresa.php">Reclamos</a></li>
                    <li><a href="app/vista/empresa.php">Soporte</a></li>
                </ul>
            </div>
            <div class="footer-links">
                <h4>Tienda</h4>
                <ul>
                    <li><a href="app/vista/calzado_hombre.php">Calzado Hombre</a></li>
                    <li><a href="app/vista/calzado_mujer.php">Calzado Mujer</a></li>
                    <li><a href="app/vista/calzado_niños.php">Calzado Niños</a></li>
                    <li><a href="app/vista/menu.php">Perfil</a></li>
                </ul>
            </div>
