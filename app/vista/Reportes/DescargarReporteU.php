...
$pdf->Cell(35,6,'TIPO DOCUMENTO',1,0,'C',1);
$pdf->Cell(44,6,'NUMERO DOCUMENTO',1,0,'C',1);
...
$sqlTrabajado = ("SELECT * FROM `usuario`");
//$sqlTrabajadores = ("SELECT * FROM trabajadores");
$query = mysqli_query($conn, $sqlTrabajado);

while ($dataRow = mysqli_fetch_array($query)) {
    $pdf->Cell(10,6,($dataRow['idUsuario']),1,0,'C');
    $pdf->Cell(35,6,$dataRow['tipoDocUsuario'],1,0,'C');
    $pdf->Cell(44,6,($dataRow['numdocUsuario']),1,0,'C');
    $pdf->Cell(28,6,$dataRow['nombreUsuario'],1,0,'C');
    $pdf->Cell(28,6,($dataRow['apellidoUsuario']),1,0,'C');
    $pdf->Cell(30,6,$dataRow['direccionUsuario'],1,0,'C');
    $pdf->Cell(30,6,($dataRow['telefonoUsuario']),1,0,'C');
    $pdf->Cell(60,6,$dataRow['correoUsuario'],1,1,'C');
}
