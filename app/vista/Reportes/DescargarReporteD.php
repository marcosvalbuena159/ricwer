...
$pdf->SetTitle('Informe de Domicilios');
...
$pdf->Cell(180,6,'LISTA DE DOMICILIOS',0,0,'C');
...
$pdf->Cell(35,6,'DOMICILIO',1,0,'C',1);
$pdf->Cell(35,6,'HORA',1,0,'C',1);
$pdf->Cell(44,6,'PEDIDO',1,0,'C',1);
$pdf->Cell(28,6,'DOMICILIARIO',1,1,'C',1); 
...
$sqlTrabajado = ("SELECT * FROM `domicilio`");
//$sqlTrabajadores = ("SELECT * FROM trabajadores");
$query = mysqli_query($conn, $sqlTrabajado);

while ($dataRow = mysqli_fetch_array($query)) {
    $pdf->Cell(35,6,($dataRow['idDomicilio']),1,0,'C');
    $pdf->Cell(35,6,$dataRow['horaDomicilio'],1,0,'C');
    $pdf->Cell(44,6,($dataRow['idPedidoFK']),1,0,'C');
    $pdf->Cell(28,6,$dataRow['idDomiciliarioFK'],1,1,'C');
}
...
$pdf->Output('Resumen_Domicilio_'.date('d_m_y').'.pdf', 'I'); 
