  ...
  switch($mensaje){
      ...
      <div class="body-contenedor">
        <div class="contenedor-sesion">
            <div class="seccion">
                ...
                <form name="FormActualizarUsuario"autocomplete="off" class="form-secion" method="POST" id="registrationForm" onsubmit="return validateForm();" accept-charset="utf-8"><!--action="../controlador/ctrl_login.php"-->
                        <div class="form-input">
                            <input type="number" placeholder="Id Usuario" name="idUsuario" class="form-control" id="idUsuario" aria-describedby="ingreso de usuario" value="<?php echo $idUsuario;?>">
                            <div class="icono">
                            <i class="fas fa-user"></i>
                        </div>
                        </div>
                        <div class="form-input">
                        <select name="TDocUsuario" class="form-control" id="texto-password">" Required>
                        ...
                        <div class="form-input">
                            <input type="number" placeholder="Documento" name="DocUsuario" class="form-control" id="texto-password" aria-describedby="ingreso de usuario" value="<?php echo $Documento;?>">
                            <div class="icono">
                            <i class="fas fa-unlock"></i>
                        </div>
                        </div class="form-boton">
                        <button type="button" class="btn-form registro" id="actualizar" class="w-75" onclick="document.FormActualizarUsuario.action='../../Controlador/actualizar/Ctrl_ActualizarUsuario.php';
                                            document.FormActualizarUsuario.submit()">ACTUALIZAR</button>
                        <!--<button type="submit" class="btn-form registro" >Actualizar</button>-->
                        
                </form>
                <!-- cambia el color de la carta con acierto, alerta y peligro -->
                <!-- <div class="carta-seccion acierto">
                    El usuario o contrasena es incorrecto
                </div> -->
            </div>
    ...
    <?php
                    ...
                    case "actualizo":
                        ...
                        echo "<a href='../consultas/ConsultaUsuario.php' class='btn btn-success'>volver</a>";
                        break;
                    case "noactualizo":
                        echo "<div class='alert alert-success'>No se actualizaron los datos del usuario correctamente</div>";
                        echo "<a href='../consultas/ConsultaUsuario.php' class='btn btn-danger'>volver</a>";
                        break;
                    case "elimino":
                        echo "<div class='alert alert-success'>Se elimino el usuario correctamente</div>";
                        echo "<a href='../consultas/ConsultaUsuario.php' class='btn btn-success'>volver</a>";
                        break;
                    case "noelimino":
                        echo "<div class='alert alert-success'>No se elimino el usuario</div>";
                        echo "<a href='../consultas/ConsultaUsuario.php' class='btn btn-danger'>volver</a>";
                        break;
                }
