...
<p class="p-3  fs-4">
        ...
        <div class="contenedor-items">
          <a class="nav-link" href="consultapedido.php">
            <div class="item">
                <span class="titulo-item">PEDIDOS</span>
                <img src="../../../public/img/pedidos.png" alt="" class="img-item">
            </div>
          </a>
          <a class="nav-link" href="consultadomicilio.php">
            <div class="item">
                <span class="titulo-item">DOMICILIO</span>
                <img src="../../../public/img/domicilios.png" alt="" class="img-item">
            </div>
          </a>
          <a class="nav-link" href="consultadetallepedido.php">
            <div class="item">
                <span class="titulo-item">DETALLE PEDIDO</span>
                <img src="../../../public/img/detallepedido.png" alt="" class="img-item">
            </div>
          </a>
          <a class="nav-link" href="consultaproducto.php">
            <div class="item">
                <span class="titulo-item">PRODUCTOS</span>
                <img src="../../../public/img/productos.png" alt="" class="img-item">
            </div>
          </a>
          <a class="nav-link" href="consultausuario.php">
            <div class="item">
                <span class="titulo-item">USUARIOS</span>
                <img src="../../../public/img/usuarios.png" alt="" class="img-item">
            </div>
          </a>
          <a class="nav-link" href="consultarolusuario.php">
            <div class="item">
                <span class="titulo-item">ROLES</span>
                <img src="../../../public/img/roles.png" alt="" class="img-item">
            </div>
          </a>
        </div>
        </section>
