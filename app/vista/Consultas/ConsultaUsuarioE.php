    ...
    <div class="body-contenedor">
        <div class="contenedor-sesion">
            <div class="seccion">
                ...
                <form autocomplete="off" class="form-secion" action="../../controlador/ctrl_consultaUE.php" method="POST"  accept-charset="utf-8">
                        <div class="form-input">
                            <input type="number" placeholder="Documento Usuario" name="Documento" class="form-control" id="texto-usuario" aria-describedby="ingreso de usuario">
                            <div class="icono">
                            <i class="fas fa-user"></i>
                        </div>
                        </div>
                        <button type="submit" class="btn-form registro" >CONSULTAR</button>
                        <?php
						if($_GET){
							$fallo=$_GET['fallo'];
							if($fallo=='error'){
