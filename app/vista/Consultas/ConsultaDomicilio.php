...
<section class="d-flex flex-column justify-content-center align-items-center pt-5  text-center w-50 m-auto" id="intro">
  ...
  <tbody>
    <?php
    require_once ("../../modelo/cls_domicilio.php");
    $Objusuario = new clsDomicilio;
    $filas=$Objusuario->consultar_domicilio();
    foreach($filas as $fila)
    {
        ?>
        <tr>
            <td><?php echo $fila['idDomicilio'];?></td>
            <td><?php echo $fila['horaDomicilio'];?></td>
            <td><?php echo $fila['idPedidoFK'];?></td>
            <td><?php echo $fila['idDomiciliarioFK'];?></td>

            <td><a href="../../controlador/editar/ctrl_editarP.php?ID=<?php echo $fila['idDomicilio']; ?>" class="btn btn-primary">EDITAR</a></td>
...
<div class="col-md-12 text-center">
  <form action="../reportes/DescargarReporteD.php" method="post" accept-charset="utf-8">
    <div class="row">
        <div class="col">
