    ...
    <div class="body-contenedor">
        <div class="contenedor-sesion">
            <div class="seccion">
                ...
                <form autocomplete="off" class="form-secion" action="../controlador/ctrl_login.php" method="POST" id="registrationForm" onsubmit="return validateForm();" accept-charset="utf-8">
                        ...
                        <div class="form-input">
                            <input type="password" placeholder="Contrasena" name="Contrasena" class="form-control" id="texto-password" >
                            <div class="icono">
                            <i class="fas fa-unlock"></i>
                        </div>
                        </div class="form-boton">
                        <button type="submit" class="btn-form registro" >INGRESAR</button>
                        <h5>Registrese <a href="Registro.php">Aquí</a></h5>
                        <?php
						if($_GET){
							$fallo=$_GET['fallo'];
							if($fallo=='error'){
