...
class clsUsuario extends clsConexion
{
    ...
    {
        $Consulta = $this->db->prepare("SELECT `idUsuario`, `tipoDocUsuario`, `numdocUsuario`, `nombreUsuario`, `apellidoUsuario`, `direccionUsuario`, `telefonoUsuario`, `correoUsuario` FROM `usuario` ");
        $filas=null;
        $Consulta->execute();
    ...
    public function consultar_usuariosE()
    {
    ...
    public function Actualizar()
    {
        ...
        try{
            ...
            $Consulta->bindParam(':idR',$this->idRol);*/
            $Consulta->execute();
            header('location:../../vista/editar/EditarUsuario.php?mensaje=actualizo');
        }
        catch(PDOException $error)
        {
            header('location:../../vista/editar/EditarUsuario.php?mensaje=noactualizo');
        }
    ...
    {
        $Consulta=$this->db->prepare("CALL Eliminar_usuarios (:idU)");
        $Consulta->bindParam(':idU',$this->idUsuario);
        if ($Consulta->execute()) {
            header('location:../../vista/editar/EditarUsuario.php?mensaje=elimino');
        }
        else{
            header('location:../../vista/editar/EditarUsuario.php?mensaje=noelimino');
        }
    }
