...
<section class="d-flex flex-column justify-content-center align-items-center pt-5  text-center w-50 m-auto" id="intro">
  ...
  <tbody>
    <?php
    require_once ("../../modelo/cls_detallepedido.php");
    $Objusuario = new clsDetallePedido;
    $filas=$Objusuario->consultar_detallepedido();
    foreach($filas as $fila)
    {
        ?>
        <tr>
            <td><?php echo $fila['idDetallePedido'];?></td>
            <td><?php echo $fila['idProductoFK'];?></td>
            <td><?php echo $fila['cantidadProducto'];?></td>
            <td><?php echo $fila['precioProducto'];?></td>
            <td><?php echo $fila['subtotalProducto'];?></td>
            <td><?php echo $fila['idPedidoFK'];?></td>

            <td><a href="../../controlador/editar/ctrl_editarPe.php?ID=<?php echo $fila['idDetallePedido']; ?>" class="btn btn-primary">EDITAR</a></td>
...
<div class="col-md-12 text-center">
  <form action="../reportes/DescargarReporteDetallePedido.php" method="post" accept-charset="utf-8">
    <div class="row">
        <div class="col">
