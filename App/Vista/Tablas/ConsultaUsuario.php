  ...
  <tbody>
    ...
    foreach($filas as $fila)
    {
        ...
        <tr>
            ...
            <td><a href="../../controlador/editar/ctrl_editarU.php?ID=<?php echo $fila['idUsuario']; ?>" class="btn btn-primary">EDITAR</a></td>
            <td><button class="btn btn-danger" onclick="alerta(<?php echo $fila['idUsuario']; ?>)">Eliminar</button></td>
              <script type="text/javascript">
                ...
                if (opcion == true) {
                  window.location.href = "../../controlador/eliminar/ctrl_eliminarU.php?ID=" + idUsuario;
                }
                }
              </script>
        </tr>
...
<div class="col-md-12 text-center">
  <form action="../reportes/DescargarReporteUsuario.php" method="post" accept-charset="utf-8">
    <div class="row">
        <div class="col">
