...
<section class="d-flex flex-column justify-content-center align-items-center pt-5  text-center w-50 m-auto" id="intro">
  ...
  <tbody>
    <?php
    require_once ("../../modelo/cls_pedido.php");
    $Objusuario = new clsPedido;
    $filas=$Objusuario->consultar_pedido();
    foreach($filas as $fila)
    {
        ...
        <tr>
            ...
            <td><?php echo $fila['horaPedido'];?></td>
            <td><?php echo $fila['totalPedido'];?></td>
            <td><?php echo $fila['pedidoaDomicilio'];?></td>
            <td><?php echo $fila['idUsuariofk'];?></td>

            <td><a href="../../controlador/editar/ctrl_editarPe.php?ID=<?php echo $fila['idPedido']; ?>" class="btn btn-primary">EDITAR</a></td>
...
<div class="col-md-12 text-center">
  <form action="../reportes/DescargarReportePedido.php" method="post" accept-charset="utf-8">
    <div class="row">
        <div class="col">
