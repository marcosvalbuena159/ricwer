...
typewriter
  ...
  document.getElementById("registroForm").addEventListener("submit", function(event) {
    ...
    // Aquí puedes hacer lo que desees con los datos, como almacenarlos en localStorage o enviarlos a un servidor
    // Por ejemplo, para mostrarlos en la consola:
    console.log("Nombre: " + nombre);
    console.log("Email: " + email);
    console.log("Mensaje: " + mensaje);

    // Puedes agregar aquí la lógica para guardar los datos en localStorage o enviarlos al servidor
